...
const quickActions = [
  ...
  { href: "/portfolio", icon: FolderKanban, label: "Build Portfolio", desc: "Turn skills into visible proof of impact", color: "text-cyan-400" },
];
...
export default function DashboardPage() {
  ...
  function exportDashboardSnapshot() {
    downloadJson("careerpilot-dashboard-snapshot.json", {
      ...
      portfolio_projects_active: portfolioActiveCount(portfolioProjects),
      portfolio_projects_published: portfolioPublishedCount(portfolioProjects),
  ...
  function exportRecentActivity() {
    downloadJson("careerpilot-recent-activity.json", {
      ...
      recent_professional_references: professionalReferences
        ...
        .sort((a, b) => b.updatedAt.localeCompare(a.updatedAt))
        .slice(0, 5),
      recent_interview_questions: questionBank
  ...
  return (
    <div className="space-y-8 max-w-6xl">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <Link href="/companies" className="rounded-2xl border border-gray-800 bg-gray-900 p-5 transition hover:border-emerald-700/60">
          <div className="text-xs text-gray-500">Target companies</div>
        ...
        <Link href="/references" className="rounded-2xl border border-gray-800 bg-gray-900 p-5 transition hover:border-emerald-700/60">
          ...
          <div className="mt-1 text-xs text-gray-500">{confirmedReferenceCount(professionalReferences)} confirmed · {professionalReferences.filter((reference) => isReferenceActionDue(reference)).length} actions due</div>
        </Link>
