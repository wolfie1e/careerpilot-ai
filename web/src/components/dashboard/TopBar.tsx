...
const pageTitles: Record<string, { title: string; subtitle: string; actionHref: string; actionLabel: string; actionIcon: typeof Plus }> = {
  ...
  "/references": { title: "Professional References", subtitle: "Prepare trusted advocates for hiring conversations", actionHref: "/planner", actionLabel: "Planner", actionIcon: UserCheck },
